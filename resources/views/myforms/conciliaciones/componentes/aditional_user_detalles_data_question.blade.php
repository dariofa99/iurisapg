...
<div class="col-md-6">
    <div class="form-group">
        ...
        <input type="text" disabled class="form-control" name="value_text_{{$data_value->id}}[]"
        ...
        $option_id = 0 ;
        @endphp
        <select disabled name="value_{{$data_value->id}}[]" id="option_id-{{$data_value->id}}"
        ...
        <input disabled id="value_other_text-{{$data_value->id}}" @if($is_active) type="text" @else type="hidden" @endif
        ...
        <label class="checkbox-inline">
            <input disabled type="checkbox" @if(isset($user) and $user!=null and $user->getDataVal($data_value->id,$option->id))
