          ...
          @elseif($solicitud->type_status_id == 162)
                  <div class="col-md-12">
                    ...
                    <a href="/login" class="btn btn-warning">Regresar</a>          
                  </div>
                      ...
                      <hr>
                       @endif 
                          <div class="row">
                            ...
                            @elseif($solicitud->type_status_id == 156 || $solicitud->type_status_id == 171 || $solicitud->type_status_id == 165)
                              <div class="row">
                            ...
                            @elseif($solicitud->type_status_id == 157)
                              ...
                              <div class="row">
                                <div class="col-md-4">
                                  <a href="/login" class="btn btn-warning btn-block">Regresar</a>
                                </div>
                              </div>
                               @elseif($solicitud->type_status_id == 158)
                               {{--      
