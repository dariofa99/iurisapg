...
@endif
              <li><a href="#tab_3" class="tab-btn-show-notas" data-toggle="tab" id="reporasistencia_btn">Reporte asistencia</a></li>
...
@endif
			...
			<tbody>
				...
				@if($turno->cursando_id == $data_search)
					...
					<td>
						{!!Form::select('color_id',$ref_color,$turno->color_id,['class' => 'form-control  input-select', 'data-live-search'=>'true', 'required' => 'required','id'=>"color_id$turno->id",'style'=>'display:none'] ); !!}



						<label id="label_color{{$turno->id}}" class="label dis-block {{$turno->getColorTurno($turno->color_ref_value) }}">{{$turno->color_nombre}}</label>
					</td>
					<td>
						{!!Form::select('cursando_id',$cursando,$turno->curso_id,['class' => 'form-control input-select', 'data-live-search'=>'true', 'required' => 'required','id'=>"cursando_id$turno->id",'style'=>'display:none'] ); !!}

						<label id="label_cursando{{$turno->id}}"> {{$turno->curso_nombre }} </label>
					</td>
					<td>
						{!!Form::select('horario_id',$ref_horarios,$turno->trnid_horario,['class' => 'form-control input-select', 'data-live-search'=>'true', 'required' => 'required','id'=>"horario_id$turno->id",'style'=>'display:none'] ); !!}
						<label id="label_horario{{$turno->id}}">
						{{$turno->horario_nombre }}
					</label>
					</td>
					<td>
						{!!Form::select('trnid_oficina',$oficinas,$turno->oficina_id,['class' => 'form-control input-select', 'data-live-search'=>'true', 'required' => 'required','id'=>"trnid_oficina$turno->id",'style'=>'display:none'] ); !!}
						...
						<td>
						{!!Form::select('trnid_dia',$dias,$turno->trnid_dia,['class' => 'form-control input-select', 'data-live-search'=>'true', 'required' => 'required','id'=>"trnid_dia$turno->id",'style'=>'display:none'] ); !!}
...
@endif
				...
				<tr>
					...
					<td>
						{!!Form::select('color_id',$ref_color,$turno->trnid_color,['class' => 'form-control  input-select', 'data-live-search'=>'true', 'required' => 'required','id'=>"color_id$turno->id",'style'=>'display:none'] ); !!}
...
<div class="row">
	<div class="col-md-6">
		<a id="btn_del_all_turnos" class="btn btn-danger"> <i class="fa fa-trash"> </i> Eliminar todos los turnos</a>
	</div>
</div>
@endif
              </div>
